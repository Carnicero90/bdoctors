...
return [
    ...
    [
        'user' => [
            'name' => 'Renè',
            'lastname' => 'Ferretti',
            'address' => 'Via Domiziana, 28 - Fiano Romano',
            'email' => 'ferrettiregista@mail.com',
        ],
        'profile' => [
            'self_description' => 'Sono Renato Ferretti detto René, sono nato a Fiano Romano il 19 settembre 1958, ma vivo e lavoro a Roma. Prima de Gli occhi del cuore 2 ho diretto altre tre fiction, ovvero Caprera, La bambina e il capitano e Libeccio, oltre che alla prima stagione de Gli occhi del cuore: ben due di queste fiction sono state sospese, rispettivamente per le proteste delle associazioni dei genitori e per i bassi ascolti. Inoltre ho diretto uno spot pubblicitario sui pannolini con uno scimpanzé come protagonista. Il mio piccolo capolavoro di è il cortometraggio ambientalista La formica rossa, realizzato di straforo dietro le quinte del set de Gli occhi del cuore 2. Un\'altra regia di alto livello che ho eseguito, è quella per il mediometraggio Passami il sale, che mi è valso un premio alla regia per la qualità. Ho un grande rispetto per il mio lavoro e spesso chiedo pubblicamente scusa per la scarsa qualità delle scene che realizzo, anche quando la colpa è degli sceneggiatori o degli interpreti; tuttavia, il più delle volte, faccio passare delle scene realizzate in modo approssimativo (a cazzo di cane per usare le mie parole) per rispettare i tempi imposti dalla rete e per non indispettire tecnici o attori.',
            'phone_number' => '345345345',
            'work_address' => 'Via Domiziana, 28 - Fiano Romano',
            'pic' =>  'img/profilo07.jpg'
        ],
    ],
    [
        'user' => [
