            ...
            <div class="col-md-12 text-center">
                ...
                <div class="dashboard">
                    <div class="mb-4 d-flex align-items-center">
                        ...
                        @endif
                        <div class="user-name">
                            <h2 class="ml-3">Ciao <a class="hover-blue"
                                    href="{{ route('profile', ['id' => $user->id]) }}">{{ $user->name }}</a>, cosa vuoi
                                fare?</h2>
                        </div>
                    </div>
                    ...
                    <div class="dash-list d-flex text-center align-items-center">
                        ...
                        {{-- Logout --}}
                        <a class="dash-link hover-blue" href="#"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2 mb-2">
                                <p class="card-text text-secondary">
                                    {{ strlen($review->content) > 69 ? substr($review->content, 0, 70) . '...' : $review->content }}
                                </p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                    ...
                    @foreach ($messages as $message)
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mt-2 mb-2">
                                    <p class="card-text text-secondary">
                                        {{ strlen($message->text) > 139 ? substr($message->text, 0, 140) . '...' : $message->text }}
                                    </p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between">
