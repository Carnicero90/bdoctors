                    ...
                    <ul class="col-12">
                        <li class="card mt-4">
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <div class="mt-2 mb-2">
                                    <h4><small>da </small>{{ $message->author_name }}</h4>
                                </div>
                                <div class="mt-2 mb-2">
                                    <h6><i class="fas fa-envelope mr-2"></i>{{ $message->author_email }}</h6>
                                </div>
                            </div>
                            {{-- END message header --}}
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <a href="{{ route('admin.message-page', ['id' => $message->id]) }}"
                                            class="btn btn-primary mr-2"><i class="far fa-file-alt mr-2"></i>Leggi</a>
